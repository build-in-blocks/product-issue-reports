---
name: Code contributor issue ticket template
about: If you are a code contributor, please use this use this issue template to create issue reports; regardless of whether its an issue, bug or suggestion.
labels: ['from: contributor', 'for: code']
title:
assignee:
...
- Replace this text with the link to (only the main) code repository concerned
